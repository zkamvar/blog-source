...
You can ususally find this out by typing `.libPaths()` in your R console. If you have an out-of-the-box installation, it will generally be somewhere like:
...
library path](https://stackoverflow.com/q/15170399/2752888) `r emo::ji("scream_cat")`.

# What if I told you there was a better way?

![](../../img/banners/smashing-library.gif)

The solution to avoid the hassle of constat library migration is to make a custom library folder[^0] and set the environmental variable 
`R_LIBS` to point to that folder `r emo::ji("+1")`. 
...
variable, these fall short[^1] `r emo::ji("man_shrugging")`. This short post will demonstrate how to persistently set the
variable without ever having to leave R `r emo::ji("sunglasses")`.
...
[^1]: Please do not take this to mean that these are bad resources. I'm just picking nits here `r emo::ji("smile")`. 
