...
tags:
  ...
  - bruvo
  - algorithms
banner: img/banners/mistake.png
---
...
| ----------------------------- | --------:| -----------:|
| (`r paste(birdz, col = " ")`) |      *p* |         1   |
| (`r paste(beagz, col = " ")`) |     *pq* |         2   |
| (`r paste(eaglz, col = " ")`) |      *q* |         1   |

The mean without the coefficient would be (*p*\**pq*\**q*/3) whereas the mean with the coefficient would be (*p*\*2*pq*\**q*/4).
...
I figure that if I am open and transparent about how I fix bugs in *poppr*, then my users will hopefully have trust in me and also be comfortable in brining up any unexpected results they find. 
